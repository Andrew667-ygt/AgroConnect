        ...
        {step === 3 && (
          <div className="animation-container fade-in">
            <img 
              ...
              className="main-animation"
            />
            <h3 className="text-white mt-4">Ready to Start Selling</h3>
            <p className="text-light">Your journey to better farm sales begins here</p>
          </div>
        )}
      </div>
        ...
        <div className="registration-card">
          ...
          {step === 1 && (
            <div className="step-content">
              <img 
                src="/gifs/welcome-farmer.gif" 
                alt="Welcome" 
                className="welcome-gif mb-4"
              />
              <h2>Welcome to AgroConnect!</h2>
              <p className="text-muted mb-4">Let's get you started with your farmer account</p>
